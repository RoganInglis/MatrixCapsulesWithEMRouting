...
flags.DEFINE_float('convcaps1_final_inverse_temp', 0.03, 'Final inverse temperature value for the first conv caps layer')
...
flags.DEFINE_float('convcaps2_final_inverse_temp', 0.03, 'Final inverse temperature value for the second conv caps layer')
...
flags.DEFINE_float('classcaps_final_inverse_temp', 0.03, 'Final inverse temperature value for the class caps layer')
