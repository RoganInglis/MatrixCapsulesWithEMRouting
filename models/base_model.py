...
class BaseModel(object):
    ...
    def __init__(self, config):
        ...
        self.final_learning_rate = self.config['final_learning_rate']
        self.learning_rate_decay_steps = self.config['learning_rate_decay_steps']
        self.l2 = self.config['l2']
        self.gradient_clipping = self.config['gradient_clipping']
        self.clipping_value = self.config['clipping_value']
        self.batch_size = self.config['batch_size']
        self.image_dim = self.config['image_dim']
        self.full_summaries = self.config['full_summaries']
